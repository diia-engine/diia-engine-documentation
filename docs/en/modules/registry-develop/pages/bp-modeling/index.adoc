...
Using tools like the *Administrative portal*, Camunda Modeler, and standards like *BPMN* and DMN,
BP modelers design *processes*, *UI forms*, and *integrations*.
Complex models often incorporate *Groovy scripting*, *JUEL functions*, and *JSON structures*.
Modelers and developers employ *REST and SOAP connectors* for interactions with external systems or other Registries on the Platform.
