...
CAUTION: *Важливо!* Якщо ви працюєте з Camunda Modeler, після проходження всіх етапів, не забудьте зберегти змодельовану схему бізнес-процесу до папки bpmn в регламенті реєстру.
...
Змінна *payload* це змінна створена та збережена у скрипті на кроці _Створення скрипт задачі "Підготовка даних документа для показу (transient var)"_.
...
[WARNING]
При створені елемента Edit Grid слід враховувати наявність складної логіки вкладених компонентів і її вплив на продуктивність рендерінгу форми.
